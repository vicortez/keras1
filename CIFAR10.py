...
filtered_X_train=numpy.array(filtered_X_train)
filtered_y_train=numpy.array(filtered_y_train)
filtered_X_test=numpy.array(filtered_X_test)
filtered_y_test=numpy.array(filtered_y_test)
...
# num_classes = filtered_y_test.shape[1]
...
# Fit the model
# model.fit(filtered_X_train, filtered_y_train, validation_data=(filtered_X_test, filtered_y_test), epochs=epochs, batch_size=32)
